...
export default function InsightsClientPage() {
  ...
  useEffect(() => {
    const fetchInsights = async () => {
      try {
        // In a real implementation, we would fetch the insights from the API
          ...
          {error ? (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Analysis and insights generated from your meeting recording</CardDescription>
              </CardHeader>
              <CardContent>
                <Tabs defaultValue="summary" className="w-full">
                  ...
                  <TabsContent value="suggestions" className="mt-6">
                    <div className="prose max-w-none" dangerouslySetInnerHTML={{ __html: insightsData?.suggestions }} />
                  </TabsContent>
                </Tabs>
              </CardContent>
            </Card>
